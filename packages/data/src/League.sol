...
contract League {
 ...
 event SquadCreated(address newAddress, uint256 squadId);
  ...
  function joinSquad(uint _index) notInOtherSquad public {
    ...
    function validPlayerInMatch(uint256 matchId, address player) isValidMerkleProof {

    }
    function validMatchGame(uint256 matchId) isValidMerkleProof {

    }
    function validMatchWinner(uint256 matchId, address player) isValidMerkleProof {
