...
export interface InGameComponentInterface extends utils.Interface {
  functions: {
...
export interface InGameComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InGameComponentInterface;
