...
export interface MoveCardComponentInterface extends utils.Interface {
  functions: {
    ...
    "getEntitiesWithValue((uint8,bool))": FunctionFragment;
    ...
    "set(uint256,(uint8,bool))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "authorizeWriter"
      | "getEntities"
      | "getEntitiesWithValue((uint8,bool))"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint8,bool))",
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint8,bool))",
