...
export type IdentityTypeStruct = {
  name: PromiseOrValue<string>;
  description: PromiseOrValue<string>;
};

export type IdentityTypeStructOutput = [string, string] & {
  name: string;
  description: string;
};
...
export interface IdentityComponentInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, IdentityTypeStruct]
  ): string;
  encodeFunctionData(
...
export interface IdentityComponent extends BaseContract {
  ...
  functions: {
    ...
    getValueTyped(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[IdentityTypeStructOutput]>;
