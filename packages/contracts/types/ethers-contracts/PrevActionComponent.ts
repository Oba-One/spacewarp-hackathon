...
export interface PrevActionComponentInterface extends utils.Interface {
  functions: {
...
export interface PrevActionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PrevActionComponentInterface;
